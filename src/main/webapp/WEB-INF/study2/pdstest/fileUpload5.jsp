...
<p><br/></p>
<div class="container">
	<h2>JAVA파일 업로드 연습 (싱글파일처리)</h2>
	<div>javax.servlet.http.Part</div> <!-- 코스라이브러이 아님 -->
	<hr/>
	<form name="myform" method="post" action="FileUpload5Ok" enctype="multipart/form-data"> <!-- 디렉토리패턴사용. 확장자x -->
