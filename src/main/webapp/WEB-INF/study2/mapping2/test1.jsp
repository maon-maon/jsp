	  ...
	  /* $(function() {
	  	...
	  	function fCheck(flag) {
	  		...
	  		if(flag == 1 || flag == 3) {
	  			...
	  			location.href = "${ctp}/study2/mapping2/Test1";
	  		}
	  		else if(flag == 4) {
  	...
  	function fCheck(flag) {
			...
			let demoFlag = flag;
				...
				if(flag == 1 || flag == 3) { /* 부분 셀프 완성 */
					...
					myform.flag.value = demoFlag;
					myform.action = "${ctp}/mapping/Test1Ok";
					myform.submit();
				}  */
...
<p><br/></p>
<div class="container">
	<h2>이곳은 test1.jsp입니다.(/WEB-INF/study2/mapping2/test1.jsp)</h2>
	<hr/>
	<div>전송된 메세지 : ${msg}</div>
	<hr/>
	<div class="row">
	...
	<hr/>
	<div>
		<form name="myform" method="post" action="${ctp}/mapping2/Test1Ok">
