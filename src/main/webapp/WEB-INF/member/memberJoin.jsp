  ...
  <form name="myform" id="myform" method="post" action="MemberJoinOk.mem" onsubmit="return fCheck()">
    ...
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td colspan="7"><input type="password" name="pwd" id="pwd" placeholder="입력하세요" class="form-control" required /></td>
      </tr>
      <tr class="mb-2">
        <th class="text-center"><label for="name" class="form-label">이름</label></th>
        <td colspan="7"><input type="text" name="name" id="name" placeholder="입력하세요" class="form-control" required /></td>
      </tr>
      ...
      <tr class="mb-2" >
        ...
        <td colspan="7">
		      	...
		      	<input type="text" name="postcode" id="sample6_postcode" placeholder="우편번호" class="form-control">
					...
					<input type="text" name="address" id="sample6_address" size="50" placeholder="주소" class="form-control mb-1" readonly>
	      	
					<div class=" input-group mb-1">
		      	<input type="text" name="detailAddress" id="sample6_detailAddress" placeholder="상세주소" class="form-control mb-1" >
						<div class=" input-group-append">
							<input type="text" name="extraAddress" id="sample6_extraAddress" placeholder="추가사항" class="form-control" >
						</div>
					</div>  		      	
        </td>
      </tr>
