...
<div class="container">
  <form name="myform" method="post" action="MemberUpdateOk.mem" onsubmit="return fCheck()">
    <h3 class="text-center">회 원 정 보 수 정</h3>
...
<%--         <td><input type="date" name="birthday" id="birthday" value="${vo.birthday.substring(0,10)}" class="form-control"></td> --%>
      ...
      <tr>
        ...
        <td>
          <div class="input-group">
            <div class="input-group-prepend"><%-- ${vo.tel}=== --%>
        ...
        <td>
          <div class="input-group mb-1">
		      	...
		      	<div class="input-group-append">
					...
					<input type="text" name="address" id="sample6_address" value="${address1}" onclick="sample6_execDaumPostcode()" placeholder="주소" class="form-control mb-1" readonly>
					<div class="input-group mb-1">
      ...
      <tr class="mb-2">
        ...
        <td>
          <div class="input-group">
	          <input type="text" name="email1" id="email1" value="${email1}" class="form-control mr-1" required /><font size="5">@</font>
	          <div class="input-group-append ml-1">
      ...
      <tr class="mb-2">
        ...
        <td>
        	<textarea rows="4" name="content" id="content" class="form-control" >${vo.content}</textarea>
        </td>
      </tr>
      <tr class="mb-2">
      ...
      <tr class="mb-2">
        ...
        <td>
          <input type="radio" name="userInfo" id="YES" value="공개" <c:if test="${vo.userInfo == '공개'}">checked</c:if> class="mr-1" /><label for="YES">공개</label> &nbsp;&nbsp;
          <input type="radio" name="userInfo" id="NO" value="비공개" <c:if test="${vo.userInfo == '비공개'}">checked</c:if> class="mr-1" /><label for="NO">비공개</label>
        </td>
      </tr>
    </table>
