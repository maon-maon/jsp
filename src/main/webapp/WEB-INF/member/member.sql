...
insert into member values(default,'admin','asdf1234','관리맨','관리자','남자',default,'010-1234-5678','28575 충북 청주시 서원구 사직대로 109, 4층','fhud_@kakao.com','관리자입니다.',default,default,default,default,default,default,default,default,default,default);
